  ...
  navigation: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Tabs', route: '/components/tabs', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-2-2h-5l-2 3H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z"></path></svg>' },
