...
import { SidebarComponent, SidebarSection, SidebarUser } from '@muxima-ui/sidebar';
      ...
      items: [
        {
          ...
          route: '/templates/dashboard/users',
          count: '2,847'
        },
        {
          label: 'Products',
          ...
          route: '/templates/dashboard/products'
        },
        {
          label: 'Orders',
          ...
          route: '/templates/dashboard/orders',
          badge: '15',
        ...
        },
        {
          ...
          route: '/templates/dashboard/payments'
        }
      ]
    },
    {
      ...
      items: [
        {
          label: 'Settings',
          icon: '<circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m5.5-11.5l-4.2 4.2M10.7 14.3l-4.2 4.2m11.5 0l-4.2-4.2m-4.2-4.2l-4.2-4.2"></path>',
          route: '/templates/dashboard/settings'
        },
        {
          label: 'Security',
          icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>',
          route: '/templates/dashboard/security'
        }
      ]
    }
  ];
