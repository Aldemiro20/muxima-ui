...
import { TableComponent, TableColumn, TablePagination, PaginationEvent, SortEvent } from '@muxima-ui/table';
...
export class TableDocComponent {
  ...
  basicData: User[] = [
    { id: 1, name: 'JoÃ£o Silva', email: 'joao@email.com', role: 'Desenvolvedor', status: 'Ativo', date: '2024-01-15' },
  ...
  fullData: User[] = [
    { id: 1, name: 'JoÃ£o Silva', email: 'joao.silva@empresa.com', role: 'Desenvolvedor Frontend', status: 'Ativo', date: '15/01/2024' },
    ...
    { id: 10, name: 'PatrÃ­cia Rocha', email: 'patricia.rocha@empresa.com', role: 'Business Analyst', status: 'Ativo', date: '22/10/2024' },
  ...
  productsColumns: TableColumn[] = [
    ...
    { key: 'price', label: 'PreÃ§o', sortable: true, align: 'right' },
    { key: 'stock', label: 'Estoque', sortable: true, align: 'center' }
  ];

  productsData = [
    { id: 1, name: 'Notebook Dell XPS 13', category: 'EletrÃ´nicos', price: 'R$ 8.999,00', stock: 15 },
    { id: 2, name: 'Mouse Logitech MX Master', category: 'PerifÃ©ricos', price: 'R$ 499,00', stock: 42 },
    { id: 3, name: 'Teclado MecÃ¢nico RGB', category: 'PerifÃ©ricos', price: 'R$ 699,00', stock: 28 },
    { id: 4, name: 'Monitor LG UltraWide 34"', category: 'Monitores', price: 'R$ 3.299,00', stock: 8 },
    { id: 5, name: 'Webcam Logitech C920', category: 'PerifÃ©ricos', price: 'R$ 599,00', stock: 35 }
  ];
  ...
  transactionsData = [
    { id: 'TXN-001', date: '13/01/2026', description: 'Venda de Produto #1234', amount: '+ R$ 2.500,00', status: 'ConcluÃ­do' },
    { id: 'TXN-002', date: '13/01/2026', description: 'Reembolso Cliente', amount: '- R$ 150,00', status: 'Processando' },
    { id: 'TXN-003', date: '12/01/2026', description: 'Assinatura Premium', amount: '+ R$ 99,00', status: 'ConcluÃ­do' },
    { id: 'TXN-004', date: '12/01/2026', description: 'Taxa de ServiÃ§o', amount: '- R$ 25,00', status: 'ConcluÃ­do' },
    { id: 'TXN-005', date: '11/01/2026', description: 'Venda de Produto #5678', amount: '+ R$ 1.899,00', status: 'ConcluÃ­do' }
  ];
  ...
  tasksColumns: TableColumn[] = [
    ...
    { key: 'assignee', label: 'ResponsÃ¡vel', sortable: true },
    { key: 'priority', label: 'Prioridade', sortable: true, align: 'center' },
    { key: 'dueDate', label: 'Prazo', sortable: true, align: 'center' }
  ];

  tasksData = [
    { id: 1, title: 'Implementar autenticaÃ§Ã£o OAuth', assignee: 'JoÃ£o Silva', priority: 'Alta', dueDate: '15/01/2026' },
    { id: 2, title: 'Corrigir bug no checkout', assignee: 'Maria Santos', priority: 'CrÃ­tica', dueDate: '14/01/2026' },
    { id: 3, title: 'Atualizar documentaÃ§Ã£o API', assignee: 'Pedro Costa', priority: 'MÃ©dia', dueDate: '20/01/2026' },
    { id: 4, title: 'Design novo dashboard', assignee: 'Ana Oliveira', priority: 'Baixa', dueDate: '25/01/2026' },
    { id: 5, title: 'Code review PR #234', assignee: 'Carlos Ferreira', priority: 'MÃ©dia', dueDate: '16/01/2026' }
  ];

  // Example 4: Sales Table
  salesColumns: TableColumn[] = [
    { key: 'month', label: 'MÃªs', sortable: true },
    { key: 'revenue', label: 'Receita', sortable: true, align: 'right' },
    { key: 'orders', label: 'Pedidos', sortable: true, align: 'center' },
    { key: 'avgTicket', label: 'Ticket MÃ©dio', sortable: true, align: 'right' },
  ...
  invoicesColumns: TableColumn[] = [
    { key: 'invoice', label: 'NÂº Fatura', sortable: true, width: '120px' },
    { key: 'client', label: 'Cliente', sortable: true },
    { key: 'issueDate', label: 'EmissÃ£o', sortable: true, align: 'center' },
  ...
  coursesColumns: TableColumn[] = [
    ...
    { key: 'rating', label: 'AvaliaÃ§Ã£o', sortable: true, align: 'center' },
    { key: 'duration', label: 'DuraÃ§Ã£o', sortable: true, align: 'center' }
  ];

  coursesData = [
    { id: 1, name: 'Angular AvanÃ§ado', instructor: 'JoÃ£o Silva', students: 1234, rating: 'â­ 4.8', duration: '40h' },
    { id: 2, name: 'TypeScript do Zero', instructor: 'Maria Santos', students: 2156, rating: 'â­ 4.9', duration: '25h' },
    { id: 3, name: 'RxJS na PrÃ¡tica', instructor: 'Pedro Costa', students: 892, rating: 'â­ 4.7', duration: '30h' },
    { id: 4, name: 'NgRx State Management', instructor: 'Ana Oliveira', students: 645, rating: 'â­ 4.6', duration: '35h' }
  ];
  ...
  eventsData = [
    { id: 1, title: 'Angular Conference 2026', date: '15/03/2026', location: 'SÃ£o Paulo - SP', attendees: 500, type: 'Presencial' },
    ...
    { id: 4, title: 'Meetup Angular Brasil', date: '25/01/2026', location: 'Belo Horizonte - MG', attendees: 150, type: 'HÃ­brido' }
  ];
