...
export class CheckboxDocComponent implements OnInit {
  ...
  description="VocÃª receberÃ¡ atualizaÃ§Ãµes sobre novos recursos e ofertas"
...
<muxima-checkbox label="Indeterminate" [indeterminate]="true"></muxima-checkbox>`,
  ...
  <muxima-checkbox 
    label="SMS" 
    description="Receber notificaÃ§Ãµes por SMS"
    [(checked)]="notifications.sms">
  </muxima-checkbox>
  <muxima-checkbox 
    label="Push" 
    description="Receber notificaÃ§Ãµes push"
