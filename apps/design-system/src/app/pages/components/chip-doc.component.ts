...
import { ChipChipComponent } from '@muxima/chip';
...
export class ChipDocComponent implements OnInit {
  ...
  importCode = `npm install @muxima/chip`;
  basicCode = `<muxima-chip label="Angular" icon="🅰️"></muxima-chip>`;

  // Estados dos chips para exemplos interativos
  basicChips = [
    { label: 'Angular', icon: '🅰️', color: 'primary' as const },
  ...
  statusChips = [
    ...
    { label: 'Info', icon: 'ℹ️', color: 'info' as const }
  ];
