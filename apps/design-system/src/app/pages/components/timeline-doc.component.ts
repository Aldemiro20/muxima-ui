...
import { TimelineTimelineComponent, TimelineItem } from '../../../../../../libs/timeline/timeline/src';
...
export class TimelineDocComponent {
  basicItems: TimelineItem[] = [
    {
      ...
      description: 'Início do desenvolvimento da biblioteca Muxima UI',
      date: '01 Jan 2026',
      time: '09:00',
      status: 'completed',
      color: 'green'
    },
    {
      ...
      description: 'Criação dos componentes principais: Button, Card, Badge',
      date: '05 Jan 2026',
      time: '14:30',
      status: 'completed',
      color: 'green'
    ...
    {
      title: 'Documentação',
      description: 'Desenvolvimento da documentação interativa',
      date: '13 Jan 2026',
      time: '10:15',
      status: 'current',
      color: 'blue'
    ...
    {
      title: 'Release 1.0',
      description: 'Primeira versão estável da biblioteca',
      date: '20 Jan 2026',
      status: 'upcoming',
      color: 'gray'
    }
  ...
  statusItems: TimelineItem[] = [
    ...
    },
    {
      ...
      description: 'Fazendo deploy para produção',
      date: 'Hoje',
      time: '09:00',
      icon: '🚀',
      status: 'current'
    ...
    {
      title: 'Monitoramento',
      description: 'Verificar métricas e performance',
      date: 'Hoje',
      time: '09:30',
      icon: '📊',
      status: 'upcoming'
    },
    {
      ...
      description: 'Problema na configuração do servidor',
      date: 'Hoje',
      time: '09:15',
      icon: '❌',
      status: 'error'
